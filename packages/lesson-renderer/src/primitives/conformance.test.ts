...
import { createRenderContext, primitiveContracts } from "../index.js";
...
function contractFor(kind: CompiledSceneObject["kind"]): PrimitiveContract {
  ...
  return {
    ...
    renderUntrusted: (object) => primitive.render(object, untrusted),
  };
}
